...
], function(declare, lang, array, topic, BaseWidget, ECharts3Layer) {
    ...
    _onTopicHandler_showOD: function(params) {
      ...
      array.forEach(
        ...
        function(endFlow) {
          ...
          var opposite = endFlow.opposite === true;
          if (startCoordinate && endCoordinate) {
            if (opposite) {
              ...
              seriesData.push(
                type.toLowerCase() === "o"
                  ? [{ coord: startCoordinate }, { coord: endCoordinate }]
                  : [{ coord: endCoordinate }, { coord: startCoordinate }]
              );
            }
          }
        },
      ...
      /* var seriesData = params.endFlows.map(
        lang.hitch(this, function(endFlow) {
          var endID = endFlow.ID;
          var endCoordinate = this.config.coordinateMap[endID];
          if (startCoordinate && endCoordinate) {
      ...
      var pointData = params.endFlows.map(
        lang.hitch(this, function(endFlow) {
          return {
