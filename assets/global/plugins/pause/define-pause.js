$(function () {
    ...
    var liFirstHeight = $ul.find(".timeline-item:first").height();//第一个li的高度
    ...
    $(".timeline-custom").hover(function () {
        ...
        scrtime = setInterval(function scrolllist() {
            ...
            $ul.animate({ top: 0 + "px" }, 1500, function () {
                //动画完成时
                $ul.find(".timeline-item:last").prependTo($ul);//将ul的最后一个剪切li插入为ul的第一个li
                liFirstHeight = $ul.find(".timeline-item:first").height();//刚插入的li的高度
