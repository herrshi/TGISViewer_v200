...
// ________________________________________________________________ settings _______________________________________________________
    ...
    var base_color_red = 141;
    var base_color_green = 212;
    var base_color_blue = 218;
    ...
    var first_color_red = 187;
    var first_color_green = 141;
    var first_color_blue = 218;
   
    var second_color_red = 141;
    var second_color_green = 212;
    var second_color_blue = 218;
