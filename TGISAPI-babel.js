...
var TMap = {
   ...
   * 隐藏动态渲染图层
   * */
  hideDynamicRendererLayer: function hideDynamicRendererLayer() {
    require(["dojo/topic"], function (topic) {
   ...
   * @param callback: function, optional.
   * */
  startDrawOverlay: function startDrawOverlay(params, callback) {
    require(["dojo/topic"], function (topic) {
   ...
   *     id: 要素编号
   * */
  backgroundGeometrySearch: function backgroundGeometrySearch(params, callback) {
    require(["dojo/topic"], function (topic) {
  ...
  locateInGeometry: function locateInGeometry(params, callback) {
    return new Promise(function (resolve, reject) {
      require(["dojo/topic"], function (topic) {
        topic.publish("locateInGeometry", { params, callback, resolve, reject });
      });
    });
  },
  /************************ Search END **************************/
  ...
  //显示街道
  showStreet: function showStreet() {
    require(["dojo/topic"], function (topic) {
      topic.publish("showStreet");
    });
  },
